...
class FeatureExtractor:
    ...
    def prepare_data_train(self, derive_dx=True):
        ...
        features, labels, groups, lastexamdate = self.fe.patientwise(derive_dx, genTest=False)

        # features.to_csv('data/feature_d1_d2_ADAS13.csv', index=False)
...
if (__name__ == '__main__'):
    dp = FeatureExtractor('data/TADPOLE_D1_D2_Dict.csv', 'data/TADPOLE_D1_D2.csv')
    ...
    np.savez('data/data_d1_d2_data.npz', features=features, labels=labels, groups=groups)
